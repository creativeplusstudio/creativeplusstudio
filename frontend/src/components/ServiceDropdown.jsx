...
export function ServiceDropdown({ onMouseEnter, onMouseLeave }) {
  return (
    <div 
      className="absolute left-1/2 transform -translate-x-1/2 mt-2 w-screen max-w-4xl bg-white shadow-lg border border-gray-200 rounded-xl p-4 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm z-50 overflow-auto"
