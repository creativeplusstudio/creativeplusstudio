      ...
      <section className="py-12 bg-orange-50">
        <div className="container mx-auto px-4 sm:px-6 lg:px-20">
          ...
          <p className="text-lg text-slate-700 mb-6">
            At CreativePlusStudio, we specialize in crafting unique and eye-catching graphic designs tailored to your brand’s identity. Our design solutions range from logos, marketing materials, and website elements to social media graphics and more.
          </p>
          <p className="text-lg text-slate-700">
